...
@Composable
fun InformationSideNavBar(selectedMenu: String, onMenuClick: (String) -> Unit) {
    val menuItems = listOf("展示个人学籍信息", "修改个人学籍信息","办理入学","办理退学") // 修改菜单项
...
//    when (selectedMenu) {
//        "展示个人学籍信息" -> DisplayAcademicInfoContent(user) // 展示个人学籍信息
...
@Composable
@Preview
fun Information_Select(user:User) {
...
fun main() = application {
    Window(onCloseRequest = ::exitApplication) {
        ...
        Information_Select(studentuser)
    }
}
